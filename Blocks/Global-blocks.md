A global block is either a header, mobile menu or footer. They're all optional (e.g. your header ideally could be converted to a mobile me by using breakpoints). 
